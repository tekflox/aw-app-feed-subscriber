// Component-mode plugin bundle only — Vite lib mode building src/plugin.jsx
// -> dist/feed-subscriber-ui.mjs, the bundle aw-app.json's
...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      formats: ['es'],
      fileName: () => 'feed-subscriber-ui.mjs',
    },
    rollupOptions: {
